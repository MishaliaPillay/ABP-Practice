...
public abstract class PracticeProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static PracticeProjectWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(PracticeProjectWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<PracticeProjectDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<PracticeProjectDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<PracticeProjectDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<PracticeProjectDbContext, Task<T>> func)
    {
        T result;
