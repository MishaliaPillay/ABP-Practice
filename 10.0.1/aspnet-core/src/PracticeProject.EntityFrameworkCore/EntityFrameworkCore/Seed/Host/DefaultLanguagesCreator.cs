...
namespace PracticeProject.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly PracticeProjectDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = PracticeProjectConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(PracticeProjectDbContext context)
    {
        _context = context;
    }
